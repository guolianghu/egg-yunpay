...
class YunPay {
     ...
     * @private
     */
    _createPaymentOrder(service, data, returnBody) {
     ...
     * @return {Promise}
     */
    returnPaymentOrder(businessId, params) {

        params.businessId = businessId;
        params.requestTime = Date.now();
        params.expiryTime = params.expiryTime || Date.now() + 1800;

        return this._createPaymentOrder('acquirer', params, true);
    }
